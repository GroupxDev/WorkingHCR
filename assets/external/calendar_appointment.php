...
$str_query = 'INSERT INTO `calendar_table` (user_email,firstName,lastname,date_request,phoneNumber) ' .
			'VALUES ("'.$_POST['modal-email'].'",
					"'.$_POST['modal-first-name'].'",
					"'.$_POST['modal-last-name'].'",
					"'.$_POST['modal-number'].'",
					"'.date('Y-m-d H:i:s').'")';
