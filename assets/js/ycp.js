...
var ibacor_ycp = function(m, n, o, p) {
    $.ajax({
        ...
        var b = a.items[0].contentDetails.relatedPlaylists.uploads,
            chid = a.items[0].id,
            nekpag = '';
        youtube_video_list(b, p, nekpag, n, chid, m)
    });
    ...
    function youtube_video_list(f, g, h, j, k, l) {
        $.ajax({
            ...
            var d = '';
            d += '<div class="ibacordotcom-vid-top"><span class="ibacordotcom-nav-title">' + j + '</span><a href="http://www.youtube.com/channel/' + l + '" target="_BLANK"><i id="youtubeFeed" class="fa fa-youtube-square"></i></a></span><hr>';
